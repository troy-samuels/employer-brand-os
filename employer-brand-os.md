...
## The Problem Every Employer Faces

When a candidate wants to know what it's like working at your company, they no longer Google you and read ten links. They ask ChatGPT. Or Claude. Or Perplexity. And those AI tools give them a single, confident answer — stitched together from Glassdoor reviews, old Reddit threads, outdated job postings, and whatever else they can scrape.

**That answer is almost certainly wrong.**

Here's what's happening right now, whether you know it or not:

- **AI is guessing your salaries.** A candidate asks "What does a Senior Developer earn at [Your Company]?" and gets a number pulled from a 2023 Glassdoor submission by someone who left unhappy. Your actual 2026 range might be £20k higher. You'll never know the candidate ruled you out.

- **Your jobs are invisible.** Most career pages output messy code that AI can't read. When someone asks an AI agent to "find me marketing jobs in Manchester," yours don't appear — not because they don't exist, but because the AI literally can't parse your page.

- **Old reviews define you.** That 2.8-star Glassdoor rating from three years ago, before you changed leadership, revamped benefits, and raised salaries? AI treats it as current fact. There's no mechanism to correct the record.

The result: **you're losing candidates before they ever visit your careers page**, and you have no visibility into it happening.

---

## Why Glassdoor Can't Fix This
...
Glassdoor has no freshness mechanism. A salary submitted in 2022 carries the same weight as one from last month. For AI agents scraping this data, "Senior Developer at Company X earns £55k" might be three years out of date — but it's the number candidates see.
...
- ❌ Replace your existing recruitment tools
- ❌ Publish exact salary figures (unless you want to)

---

## The Shadow Salary Problem

Here's something most employers don't realise: **AI already publishes salary estimates for your roles.** It doesn't wait for your permission.

When a candidate asks "What does a Product Manager earn at [Your Company]?", AI constructs an answer from:
- Glassdoor submissions (often years old, unverified)
- Indeed salary estimates (algorithmic guesses)
- Old job postings that may have listed ranges
- Reddit discussions and anonymous forums
- General market data loosely applied to your company

The result is what we call a **Shadow Salary** — the number AI thinks you pay, which may bear no resemblance to what you actually pay.

### A real scenario:

> **Candidate asks ChatGPT:** "What's the salary for a Senior Engineer at Acme Corp?"
>
> **ChatGPT responds:** "Based on available data, Senior Engineers at Acme Corp typically earn between £55,000–£68,000."
>
> **Acme Corp's actual 2026 range:** £75,000–£95,000
>
> **What happens:** The candidate doesn't apply. They never visit the careers page. Acme never knows they lost them. The AI got it wrong by £20k, and there was no mechanism to correct it.
...
**Best for:** Companies that want to start small, or in markets with no transparency requirements.

### Level 2 — Range Verified
*"We pay competitively, and here's the proof."*

You share broad salary bands (e.g., "£60k–£100k for engineering roles") and a Compensation Confidence indicator — a signal that tells candidates and AI agents you're in the top tier for your market, without revealing exact figures.

**Best for:** Companies that want to counter Glassdoor's guesswork without full disclosure.
...
### Level 4 — Total Compensation Intelligence
*"Salary is just the start. Here's the full picture."*

Full salary ranges plus benefits valuation, equity details, flexible working policies, learning budgets, parental leave — everything that makes up the real value of working for you. Most of this data is invisible to AI today. Level 4 makes it the first thing candidates see.

**Best for:** Companies whose benefits package is a genuine differentiator.

---

## The Compensation Confidence Score

Most companies can't — or won't — share exact salary figures. We built something for them.

The **Compensation Confidence Score** is a verified signal that tells AI agents and candidates three things:

1. **This data is employer-verified.** Not self-reported by an anonymous reviewer, but confirmed by the company itself.
2. **This data is current.** Timestamped to the day. AI agents prioritise fresh data over stale estimates.
3. **This company pays competitively.** A market positioning indicator (e.g., "Top 30% for this role in this location") without revealing the number.

Think of it as a credit score for employer reputation. Candidates see it and know the company takes compensation seriously. AI agents see it and cite it over Glassdoor's guesses. And the company never had to publish a single salary figure.
...
1. **Structured data** it can read easily (almost no companies provide this)
2. **Recent content** with clear dates (Glassdoor reviews, news articles)
3. **Popular sources** with high engagement (Reddit threads, viral reviews)
4. **General market data** when company-specific data is thin
...
| Benefits pulled from an old job ad | Your full 2026 benefits package — equity, healthcare, parental leave | Total compensation becomes visible |
| Generic company description | Your verified culture, values, and team information | Your employer brand, in your words |
| Nothing (your jobs are invisible) | Structured job listings AI can actually read | Your roles appear in AI job searches |
...
1. **See your Shadow Salary** — We run a free audit showing you exactly what AI currently says about your company, including salary estimates and factual errors
2. **Choose your disclosure level** — From basic verification to full transparency, based on your comfort and legal requirements
3. **Go live in under five minutes** — Your marketing or HR team pastes one line into Google Tag Manager. No developers, no IT tickets
4. **Get your first Monday Report** — Within a week, you'll see exactly how AI is citing your corrected data
...
|---|---|---|
| **Visibility** | £299/month | Shadow Salary audit, AI-readable data injection, Hosted Verification Page, basic Monday Report |
| **Compliance** | £899/month | Everything above, plus automated pay transparency compliance by jurisdiction, full Monday Report with competitor benchmarking, Compensation Confidence Score |
...
Even if salary disclosure feels optional today, regulation is moving fast:

- **New York City** — Salary ranges required on all job postings (active now)
- **California** — Salary disclosure mandatory for companies with 15+ employees (active now)
...
We're in the early days of a fundamental shift in how people find jobs. The old model — job boards, Google searches, LinkedIn browsing — is being replaced by AI-mediated discovery. Candidates don't search for jobs. They ask AI to find them.
