/**
 * Deprecated BrandOS runtime.
 *
 * Compatibility bridge that forwards to the canonical Rankwell runtime:
 * /api/pixel/v1/script.
 */
(function () {
  "use strict";
  ...
  try {
    var current =
      ...
      document.querySelector(
        'script[data-brandos-key],script[data-key],script[data-rankwell-key]'
      );
    if (!current) return;
