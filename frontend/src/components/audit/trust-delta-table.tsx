  ...
  return (
    ...
    >
      <div className="border-b border-slate-200 px-5 py-4 sm:px-6">
        <h2 className="text-lg font-semibold text-slate-900">Trust Delta</h2>
            ...
            return (
              <TableRow key={item.category} className="align-top">
                ...
                <TableCell>
                  {showUnknownReality ? (
                    <span
                      className="inline-flex items-center gap-1 rounded-md border border-dashed border-neutral-300 px-2.5 py-1 text-xs font-semibold text-slate-500"
                ...
                <TableCell>
                  {item.delta ? (
                    ...
                    <span className="text-sm text-slate-400">Awaiting published data</span>
                  )}
                </TableCell>
              </TableRow>
            );
