/**
 * @module components/landing/hero-audit
 * Interactive hero section — handles the audit flow (idle → running → complete).
 * Extracted as a client component island so the main page can be a server component.
 */
      ...
      <div className="relative mx-auto flex max-w-[1200px] flex-col items-center px-6 py-24 lg:px-12 lg:py-32">
        ...
        <AnimatePresence mode="wait">
          {state !== "complete" && (
            ...
            >
              <h1
                className="mb-5 text-5xl font-medium leading-[1.04] text-neutral-950 sm:text-6xl lg:text-7xl"
              ...
              <p className="text-lg text-neutral-400 max-w-lg mx-auto">
                Candidates research you in AI before they apply, engage, or accept. Run a free
                employer brand audit — see your score across ChatGPT, Claude, Perplexity and Gemini,
          ...
          {state === "idle" && (
            ...
            >
              ...
              <p className="mt-4 text-center text-xs text-neutral-400">
                340+ UK employers audited · Average employer brand score:{" "}
                <span className="font-semibold text-neutral-500">32/100</span> ·{" "}
                <span className="font-semibold text-status-critical">68%</span> have incomplete
                employer data in AI search
              </p>
              {error && (
                <motion.p
                  initial={{ opacity: 0 }}
