...
const ASSUMPTIONS = {
  ...
  /** Monthly cost of OpenRole Compete plan (annual) */
  openroleMonthlyCost: 239,
};
                ...
                >
                  ...
                  <div className="grid gap-4 sm:grid-cols-2 mb-6">
                    ...
                    <div className="rounded-xl bg-teal-50 border border-teal-200 p-5">
                      ...
                      <p className="text-xs text-slate-400 mt-2">
                        Compete plan (£{ASSUMPTIONS.openroleMonthlyCost}/mo = £{results.openroleAnnualCost.toLocaleString("en-GB")}/yr) could
