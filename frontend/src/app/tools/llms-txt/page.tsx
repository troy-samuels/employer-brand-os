 ...
 * - Captures intent (if you need this, you need OpenRole)
 *
...
function generateLlmsTxt(data: FormData): string {
  ...
  lines.push("---");
  lines.push("");
  lines.push(`*This file was generated by OpenRole (https://openrole.co.uk/tools/llms-txt).*`);
        ...
        <section className="py-12 border-t border-slate-200 bg-white">
          <div className="mx-auto max-w-2xl px-6 text-center">
            ...
            <p className="text-sm text-slate-500 mb-6">
              llms.txt is step one. A full OpenRole audit checks 50+ signals
