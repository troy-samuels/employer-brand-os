                ...
                <tr>
                  <td style="padding: 20px 24px; background: #f0fdfa;">
                    ...
                    <p style="margin: 0 0 12px; font-size: 14px; color: #334155; line-height: 1.5;">
                      We're onboarding our first 20 customers at <strong>£199/month</strong> (locked forever, normally £299/mo) —
                      that's the full Compete plan including content playbook, 5 competitor benchmarks, ATS integration, and displacement reports.
                    </p>
